...
if st.session_state.page == 'lang_selection':
    st.markdown("""
        ...
        .lang-card { 
            ...
            text-align: center; 
            margin-top: 50px; 
            margin-bottom: 45px !important; /* التباعد المدروس لمنع الالتصاق */
            box-shadow: 0 10px 30px rgba(0,0,0,0.1); 
        }
        
        /* أنيميشن فخم وسلس مخصص لأزرار اللغتين */
        div[data-testid="stHorizontalBlock"] .stButton > button {
            ...
            transition: all 0.35s cubic-bezier(0.4, 0, 0.2, 1) !important; /* حركة انسيابية ناعمة */
        }
        
        div[data-testid="stHorizontalBlock"] .stButton > button:hover {
            transform: translateY(-5px) scale(1.02) !important; /* تأثير الارتفاع والتكبير المايكرو عند التحويم */
...
if st.session_state.page == 'welcome':
    ...
    with col_s:
        ...
        stars = st.columns(5)
        for i in range(1, 6):
            # تم حذف أيقونة النجمة وعرض الأرقام فقط داخل الكتل المربعة المتناسقة بناءً على طلبكِ
