...
if st.session_state.page == 'lang_selection':
    st.markdown("""
        ...
        .lang-card { background: rgba(255, 255, 255, 0.8); backdrop-filter: blur(10px); padding: 40px; border-radius: 30px; text-align: center; margin-top: 50px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); }
        </style>
