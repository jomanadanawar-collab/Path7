...
# 3. إدارة الحالة داخل الـ session_state
...
st.markdown(f'''
    ...
    * {{ font-family: {"'IBM Plex Sans Arabic'" if IS_AR else "'Inter'"}, sans-serif !important; direction: {"rtl" if IS_AR else "ltr"}; }}
    ...
    /* ستايل مخصص لزر تغيير اللغة العلوي ليكون أنيقاً ومتجاوباً */
...
# إضافة زر تغيير اللغة في أعلى الشاشة الرئيسية بطريقة متجاوبة بالكامل بدلاً من الـ Sidebar
